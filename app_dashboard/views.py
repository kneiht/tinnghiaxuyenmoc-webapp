...
def download_excel(request, model_name):
    ...
    try:
        ...
        if hasattr(model_class, 'excel_columns'):
            ...
            fields = model_class.excel_columns
        else:
            # Fall back to all non-primary key fields
            fields = [field.name for field in model_class._meta.fields if not field.primary_key]
